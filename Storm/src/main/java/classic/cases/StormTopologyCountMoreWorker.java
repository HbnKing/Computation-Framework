 ...
 *
 */
public class StormTopologyCountMoreWorker {
	...
	public static void main(String[] args) {
		...
		String topologyName = StormTopologyCountMoreWorker.class.getSimpleName();
		Config config = new Config();
		config.setNumWorkers(2);//设置 work进程个数
		//当worker  挂了之后  会自动启动一个worker  
		if(args.length==0){
			//创建一个本地集群运行程序
