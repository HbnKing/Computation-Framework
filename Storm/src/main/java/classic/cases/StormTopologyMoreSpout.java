 ...
 *
 */
public class StormTopologyMoreSpout {
	...
	public static class MySpout2 extends BaseRichSpout{
	...
	public static void main(String[] args) {
		...
		topologyBuilder.setSpout("spout2", new MySpout2());
		topologyBuilder.setBolt("bolt1", new MyBolt()).shuffleGrouping("spout1").shuffleGrouping("spout2");
		
		StormTopology createTopology = topologyBuilder.createTopology();
		String topologyName = StormTopologyMoreSpout.class.getSimpleName();
