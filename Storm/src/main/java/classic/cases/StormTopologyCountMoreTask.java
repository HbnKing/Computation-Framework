 ...
 *
 */
public class StormTopologyCountMoreTask {
	...
	public static void main(String[] args) {
		...
		topologyBuilder.setBolt("bolt1", new MyBolt()).setNumTasks(3).shuffleGrouping("spout1");
		
		StormTopology createTopology = topologyBuilder.createTopology();
		String topologyName = StormTopologyCountMoreTask.class.getSimpleName();
