 ...
 *
 */
public class StormTopologyGlobalGrouping {
	...
	public static void main(String[] args) {
		...
		//设置globalGrouping 可以实现不管给这个组件设置几个线程，所有的数据还是只会让一个线程去处理
		...
		String topologyName = StormTopologyGlobalGrouping.class.getSimpleName();
