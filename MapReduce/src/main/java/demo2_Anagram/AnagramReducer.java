...
*/
    ...
    public void reduce(Text anagramKey, Iterable< Text> anagramValues,
		...
		//sbr.length() 求得是字符长度   ,所以这里添加一个计数器
		if(count >= 2){
			//context.write(anagramKey, new Text(sbr.toString()));
			context.write(new Text(sbr.toString()),new Text(""));
