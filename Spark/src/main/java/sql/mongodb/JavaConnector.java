    ...
    public static void main(String args[]) throws ParseException {
            try {
               ...
               // mongoClient = new MongoClient(addressLists, credentialsLists);
                ...
                String uriStr = "mongodb://192.168.3.131:27017/MK_Test.Tag_Field?replicaSet=wh";

                mongoClient = new MongoClient(new MongoClientURI(uriStr));
                MongoCollection<Document> collection = mongoClient.getDatabase("MK_Test").getCollection("Tag_Field");
                MongoCursor<Document> u = collection.find(eq("u", 2447005)).iterator();
                while (u.hasNext()){
